...
public class L2AlgaePos extends Command {
   ...
   */
    public L2AlgaePos(Elevator elevator, AlgaeIntake algaeIntake, CoralIntake coralIntake) {
    m_Elevator = elevator;
  ...
  public void initialize() {
    ...
    m_Elevator.setElevatorDesiredPosition(Constants.kElevatorL2AlgaePos);
    m_isFinished = true;
