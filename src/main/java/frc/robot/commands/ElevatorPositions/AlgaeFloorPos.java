...
public class AlgaeFloorPos extends Command {
   ...
   */
    public AlgaeFloorPos(Elevator elevator, AlgaeIntake algaeIntake, CoralIntake coralIntake) {
    m_Elevator = elevator;
  ...
  public void initialize() {
    ...
    m_AlgaeIntake.setAlgaeRotatePos(Constants.kAlgaeFloorPickupPos);
