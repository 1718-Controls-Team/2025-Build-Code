...
public static final double kAlgaeHomePos = 0.5; // potentially like 7
...
*/
  ...
  public static final double[] kRed9R = {(12.162), 5.214, 120};                           //RIGHT
  public static final double[] kRed9L = {(12.462831), 5.3457, 120};                       //LEFT
  public static final double[] kRed8R = {(13.632), 5.396, 60};                              //RIGHT
  public static final double[] kRed8L = {(13.9), 5.2, 60};                         //LEFT
  public static final double[] kRed7R = {(14.535), 4.21, 0};                          //RIGHT
  public static final double[] kRed7L = {(14.500879), 3.886447, 0};                       //LEFT
  public static final double[] kRed6R = {(12.843), 3.07, 300};                          //RIGHT
  public static final double[] kRed6L = {(13.636), 2.702, 300};                          //LEFT
  public static final double[] kRed11R = {(12.479), 2.655, 240};                         //RIGHT
  public static final double[] kRed11L = {(12.21), 2.854, 240};                           //LEFT
  public static final double[] kRed10R = {(11.628), 3.807, 180};                            //RIGHT
  public static final double[] kRed10L = {(11.628), 4.188, 180};                               //Left

  public static final double[] kBlueBargeProc = {7, 5.075, 162.408};
  public static final double[] kBlueBargeMid = {7, 6.170, 162.408};
  public static final double[] kBlueBargeLeft = {7, 7.265, -162.408};
  public static final double[] kBlueFarBargeProc = {10.55, 5.075, -17.592};
  public static final double[] kBlueFarBargeMid = {10.55, 6.170, 17.592};
  public static final double[] kBlueFarBargeLeft = {10.55, 7.265, 17.592};

  public static final double[] kRedBargeProc = {10.55, 3.005, 17.592};
  public static final double[] kRedBargeMid = {10.55, 1.91, 17.592};
  public static final double[] kRedBargeLeft = {10.55, 0.815, 17.592};
  public static final double[] kRedFarBargeProc = {7, 3.005, -162.408};
  public static final double[] kRedFarBargeMid = {7, 1.91, 162.408};
  public static final double[] kRedFarBargeLeft = {7, 0.815, 162.408};

  public static final double[] kBlueLeftCoralStation = {1.708, 7.315, -54};
  public static final double[] kBlueRightCoralStation = {1.716, 0.709, 54};
